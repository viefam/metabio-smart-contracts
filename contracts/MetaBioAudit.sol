// Thank you inspiration: https://github.com/thirdweb-dev/contracts/blob/main/contracts/vote/VoteERC20.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.11;

// Base
import "./interfaces/IMetaBioContract.sol";
...
{
    bytes32 private constant MODULE_TYPE = bytes32("MetaBioAudit");
    uint256 private constant VERSION = 1;

    string public contractURI;
    uint256 public proposalIndex;

    struct MetaBioProposal {
        uint256 proposalId;
        address proposer;
        address[] targets;
        uint256[] values;
    ...
    function propose(
        ...
        proposals[proposalIndex] = MetaBioProposal({
    ...
    function getAllProposals()
        external
        view
        returns (MetaBioProposal[] memory allProposals)
    {
        uint256 nextProposalIndex = proposalIndex;

        allProposals = new MetaBioProposal[](nextProposalIndex);
